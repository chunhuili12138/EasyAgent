...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  /** Reload tenant-scoped routes and tabs after tenant/global context changes. */
  async function reloadAuthRoutes() {
    ...
    await initAuthRoute();
    await router.replace({ name: routeHome.value });
  }
  ...
  async function initDynamicAuthRoute() {
    ...
    if (!error) {
      ...
      // 消息通知：静态路由，所有角色可用，不在数据库中配置
      routes.push({
        id: '9001',
        name: 'message',
        path: '/system/message',
        component: 'layout.base$view.system_message',
        meta: {
