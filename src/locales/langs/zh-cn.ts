const local = {
  ...
  rag: {
    ...
    skill: {
      ...
      aiIntro: '输入名称、编码、完整流程描述和一条真实试运行问题。系统会让正常问答 Agent 执行，按实际工具参数、依赖、结果和最终回答审查目标是否完成；若首次路线缺少证据或范围错误，会保留首次失败并受控重执行一次，最后从通过审查的成功账本生成默认禁用的 Skill 草稿。',
      aiDescription: '完整描述',
