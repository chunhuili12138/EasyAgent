const local: App.I18n.Schema = {
  ...
  automation: {
    enum: {
      status: {
        draft: 'Draft', published: 'Published', disabled: 'Disabled', archived: 'Archived', superseded: 'Superseded', created: 'Created', queued: 'Queued', pending: 'Pending',
        ready: 'Ready', readyToResume: 'Ready to resume',
        running: 'Running', waiting: 'Waiting', waitingEvent: 'Waiting for event', waitingTimer: 'Waiting for timer', pendingApproval: 'Pending approval',
        retryWait: 'Waiting to retry', success: 'Success', partialFailure: 'Partial failure', failed: 'Failed', cancelled: 'Cancelled', skipped: 'Skipped',
        open: 'Open', replayed: 'Replayed', discarded: 'Discarded', received: 'Received', processed: 'Processed', started: 'Started', matched: 'Matched',
        unmatched: 'Unmatched', rejected: 'Rejected', approved: 'Approved', timeout: 'Timed out'
      },
      triggerType: {
        manual: 'Manual', cron: 'Schedule', webhook: 'Webhook', event: 'Internal event', approval: 'Approval callback', retry: 'Retry', subflow: 'Subflow'
      },
      sourceType: { internal: 'Internal event', webhook: 'Webhook', cron: 'Schedule', approval: 'Approval callback' },
      failureType: {
        validation: 'Validation failure', auth: 'Authentication or authorization failure', rateLimit: 'Rate limited', timeout: 'Execution timeout',
        transient: 'Transient connection failure', business: 'Business processing failure', policy: 'Policy blocked', cancelled: 'Task cancelled', unknown: 'Unknown failure'
      },
      eventType: {
        approval: 'Approval callback event', webhook: 'Webhook event', afterSalesAcceptance: 'After-sales acceptance event',
        runStarted: 'Run started', runCompleted: 'Run completed', runCancelled: 'Run cancelled', runRetried: 'Run retried', runReconciled: 'Run reconciled',
        nodeStarted: 'Node started', nodeCompleted: 'Node completed', nodeFailed: 'Node failed', nodeFailedHandled: 'Node failure handled',
        nodeRetryScheduled: 'Node retry scheduled', eventWaitStarted: 'Event wait started', eventWaitCompleted: 'Event wait completed',
        externalEventReceived: 'External event received'
      }
    },
    common: {
      refresh: 'Refresh', search: 'Search', reset: 'Reset', save: 'Save', cancel: 'Cancel', edit: 'Edit', create: 'Create',
      action: 'Actions', status: 'Status', type: 'Type', name: 'Name', workflow: 'Workflow', version: 'Version',
      allStatus: 'All statuses', enabled: 'Enabled', disabled: 'Disabled', enable: 'Enable', disable: 'Disable',
      createdAt: 'Created at', updatedAt: 'Updated at', completedAt: 'Completed at', startedAt: 'Started at',
      errorCode: 'Error code', errorSummary: 'Error summary', executor: 'Worker', runId: 'Run ID', nodeRun: 'Node run',
      attempts: 'Attempts', attempt: 'Attempt', itemKey: 'Item key', payloadHash: 'Payload hash', totalItems: '{count} total', totalRecords: '{count} records', configurationHelp: 'Configuration help',
      jsonInvalid: '{field} must be valid JSON', copied: 'Copied', default: 'Default', locate: 'Locate', previous: 'Back', next: 'Next',
      loadFailed: 'Unable to load automation data. Check the service and try again.', retryLoad: 'Retry',
      tenantRequired: 'Automation data is tenant-scoped. Select an active tenant before continuing.'
    },
    workflow: {
      title: 'Workflow Design', description: 'Manage publishable and resumable automation definitions', create: 'New workflow',
      searchPlaceholder: 'Search name or code', draft: 'Draft', published: 'Published', archived: 'Archived',
      descriptionLabel: 'Description', openDesigner: 'Open designer', saved: 'Saved', dirty: 'Unsaved changes',
      saving: 'Saving', conflict: 'Save conflict', saveError: 'Save failed', reload: 'Reload', readonlyDsl: 'Read-only DSL',
      validate: 'Validate', testRun: 'Test run', runPublishedVersion: 'Run published v{version}', noPublishedVersion: 'Not published', publish: 'Publish', viewAllErrors: 'View all {count}',
      createTitle: 'Create Workflow', code: 'Code', createAndDesign: 'Create and design', input: 'Workflow input',
      variables: 'Run variables', submitRun: 'Submit run', dslTitle: 'Workflow DSL (read-only)',
      nameRequired: 'Enter a workflow name', codeRequired: 'Enter a workflow code',
      codeRule: 'Use 3-64 lowercase letters, digits, or underscores, starting with a letter', created: 'Workflow created',
      conflictMessage: 'This draft changed in another session. Reload before continuing.', draftSaved: 'Draft saved',
      validationPassed: 'Workflow validation passed', validationFailed: '{count} issues found',
      publishConfirm: 'After publishing v{version}, runs will remain pinned to that version.', publishTitle: 'Publish workflow',
      publishedMessage: 'Workflow published', runJsonInvalid: 'Run input must be valid JSON',
      ...
      draftNotIncluded: 'The designer shows draft v{draftVersion}; this run executes published v{publishedVersion} and excludes draft changes.',
      ...
      archivedMessage: 'Workflow archived and its triggers disabled', restoredMessage: 'Workflow restored as an editable draft',
      deletedMessage: 'Draft workflow deleted',
      runSubmitted: 'Run #{id} submitted', template: 'Starter template', namePlaceholder: 'For example: Automatic Customer Complaint Handling',
      codePlaceholder: 'For example: auto_customer_complaint', descriptionPlaceholder: 'Describe triggers, goals, outputs, and unsupported scenarios',
      templates: { blank: 'Blank workflow', sequential: 'Sequential processing', approval: 'External approval', batch: 'Batch processing' },
      templateHints: { blank: 'Start and end nodes only', sequential: 'Input transform and API nodes', approval: 'Wait state with success and timeout exits', batch: 'Batch loop with throttling defaults' }
    },
    trigger: {
      title: 'Trigger Management', description: 'Configure workflow entry points, activation, and signing secrets', cron: 'Schedule',
      webhook: 'Webhook', event: 'Internal event', approval: 'Approval provider', createType: 'New {type}', editType: 'Edit {type}',
      selectWorkflow: 'Select a workflow', overlapPolicy: 'Overlap policy', publicKey: 'Public key', nextFireAt: 'Next run',
      rotateSecret: 'Rotate secret', cronExpression: 'Spring Cron (6 fields)', cronPreset: 'Frequency', timezone: 'IANA timezone',
      misfireWindow: 'Misfire window (seconds)', signatureWindow: 'Signature window (seconds)', eventType: 'Event type',
      callbackSchema: 'Callback Schema', payloadSchema: 'Payload Schema', input: 'Workflow input', variables: 'Run variables',
      required: 'Select a workflow and enter a name', updated: 'Trigger updated', created: 'Trigger created',
      enabled: 'Trigger enabled', disabled: 'Trigger disabled', rotateConfirm: 'The old secret stops working immediately. Continue?',
      secretOnce: 'Secret shown once', secretWarning: 'Store it in a secure secret manager now. It cannot be viewed again.',
      callbackPath: 'Callback path', signingSecret: 'Signing secret', savedSecret: 'Stored securely',
      formatJson: 'Format JSON', fillExample: 'Use example',
      namePlaceholder: 'For example: Daily Complaint Processing', cronPresetPlaceholder: 'Select a common frequency',
      cronPlaceholder: 'For example: 0 0 9 * * *', timezonePlaceholder: 'Select or enter an IANA timezone',
      misfirePlaceholder: '0-86400 seconds', overlapPlaceholder: 'Select an overlap policy',
      signatureWindowPlaceholder: '30-3600 seconds', eventTypePlaceholder: 'For example: after_sales.acceptance',
      cronPresets: {
        custom: 'Custom expression', hourly: 'Hourly', daily: 'Daily at 09:00', everyFiveMinutes: 'Every 5 minutes',
        everySevenDays: 'Every 7 days (Monday 09:00)', everyThirtyDays: 'Every 30 days (day 1 at 09:00)'
      },
      overlap: { skip: 'Skip this run', queue: 'Run once after the active instance finishes', parallel: 'Run in parallel', replace: 'Replace active run' }
    },
    run: {
      title: 'Workflow Runs', description: 'Inspect execution status, node traces, and retry history', instanceCount: '{count} runs',
      triggerType: 'Trigger', duration: 'Duration', viewDetail: 'View details', cancel: 'Cancel', retry: 'Retry',
      detail: '{name} · Run #{id}', graph: 'Execution graph', nodes: 'Nodes {count}', node: 'Node',
      loopBatches: 'Loop batches {count}', batchId: 'Batch ID', loopNode: 'Loop node', progress: 'Progress',
      progressText: '{completed} succeeded / {failed} failed / {total} total', concurrency: 'Concurrency', rateLimit: 'Rate/sec',
      loopItems: 'Loop items', loopDetail: 'Loop batch #{id} · Items', viewLoopItems: 'View items', retryFailed: 'Retry failures', timeline: 'Timeline {count}',
      nextRetry: 'Next retry', cancelConfirm: 'Cancel run #{id}?', cancelTitle: 'Cancel run', cancelled: 'Run cancelled',
      retryCreated: 'Retry run #{id} created', retryBatchConfirm: 'Retry failed items in batch #{id}?',
      retryBatchTitle: 'Retry loop items', retryBatchSuccess: 'Failed loop items were rescheduled'
    },
    operations: {
      logTitle: 'Execution Logs', failureTitle: 'Failed Tasks', eventTitle: 'Event Records',
      logDescription: 'Inspect every node attempt, retry, and error summary', failureDescription: 'Handle dead letters and workflow failure causes',
      eventDescription: 'Track published, received, matched, and triggered events', inbox: 'Received', outbox: 'Published',
      eventType: 'Event type', deadLetterId: 'Dead letter ID', failureType: 'Failure type', handledBy: 'Handled by',
      handledAt: 'Handled at', safeRetry: 'Safe retry', discard: 'Discard', eventId: 'Event ID', source: 'Source',
      trigger: 'Trigger', occurredAt: 'Occurred at', discardConfirm: 'Discard dead letter #{id} and stop retrying?',
      discardTitle: 'Discard dead letter', discarded: 'Dead letter closed', retryConfirm: 'Retry with the pinned version from run #{id}?',
      retryTitle: 'Retry dead letter', retryCreated: 'Retry run #{id} created'
    },
    statistics: {
      title: 'Runtime Statistics', description: 'Monitor tenant throughput, backlog, waits, and execution health', reconcile: 'Reconcile now',
      reconcileConfirm: 'Compare recent tenant runs with Flowable state and repair deterministic differences. Continue?',
      startReconcile: 'Start reconciliation', reconcileFailed: 'Reconciliation request failed', repaired: 'Repaired {count} run states',
      noRepair: 'Reconciliation complete; no repairable differences found', totalRuns: 'Total runs', activeRuns: 'Active runs',
      queuedRuns: 'Queued', waitingRuns: 'Waiting', successRate: 'Success rate', failureRate: 'Failure rate',
      retryAttempts: 'Retry attempts', openDeadLetters: 'Open dead letters', avgDuration: 'Average run duration',
      avgQueueDelay: 'Average queue delay', avgWait: 'Average current wait', avgNodeDuration: 'Average node duration',
      statusDistribution: 'Run status distribution', generatedAt: 'Generated {time}', instances: 'Runs', ratio: 'Share',
      lastReconcile: 'Latest manual reconciliation', autoReconcile: 'Runs automatically every 5 minutes',
      reconcileIncomplete: 'Reconciliation incomplete', inspected: 'Inspected', repairedCount: 'Repaired',
      activeTerminal: 'Business terminal but engine active: {ids}', unresolved: 'Temporarily unresolved: {ids}',
      noDifference: 'No differences require intervention', neverReconciled: 'No manual reconciliation yet', overview: 'Run overview', latency: 'Latency metrics'
    },
    designer: {
      nodeLibrary: 'Node library', variables: 'Variables', undo: 'Undo', redo: 'Redo', autoLayout: 'Auto layout', fit: 'Fit view',
      deleteSelected: 'Delete selected', canvasCount: '{nodes} nodes · {edges} edges', nodeProperties: 'Node properties',
      edgeProperties: 'Edge properties', workflowSettings: 'Workflow settings', readonly: 'Read-only', nodeName: 'Node name', nodeId: 'Node ID',
      duration: 'Wait duration', aggregateStrategy: 'Aggregate strategy', waitPolicy: 'Wait policy', tool: 'Tool', itemsPath: 'Array path',
      batchSize: 'Batch size', concurrency: 'Concurrency', rateLimit: 'Rate per second', failureThreshold: 'Failure threshold',
      resource: 'Resource', resourcePlaceholder: 'Select an enabled resource by name',
      resourceAlias: 'Resource alias', resourceAliasHint: 'Generated and pinned when a resource is selected', approvalProviderId: 'Approval provider ID',
      systemInstruction: 'Node instruction', systemInstructionPlaceholder: 'Define the task, allowed evidence, output JSON, and missing-data behavior',
      model: 'Model override', modelPlaceholder: 'Leave blank to use the configured default model', maxCompletionTokens: 'Maximum output tokens',
      correlationPath: 'Correlation key path', approvalTimeout: 'Approval timeout', executionPolicy: 'Execution policy', retries: 'Retries',
      timeoutMs: 'Timeout (ms)', retryDelay: 'Retry delay', failurePolicy: 'Failure policy', failureTarget: 'Failure target',
      source: 'Source', target: 'Target', condition: 'Condition expression', defaultBranch: 'Default branch',
      advancedConfig: 'Advanced data configuration', nodeConfig: 'Node config JSON', inputSchema: 'Input Schema', inputMapping: 'Input mappings', outputSchema: 'Output Schema',
      applyJson: 'Apply JSON', useTemplateExample: 'Use template example', jsonApplied: 'Configuration applied', jsonError: '{field} is not valid JSON',
      selectHint: 'Select a node or edge to configure', onlyOneStart: 'A workflow can only have one start node',
      nodeNamePlaceholder: 'Enter a recognizable node name', aggregateStrategyPlaceholder: 'Select an aggregation strategy',
      waitPolicyPlaceholder: 'Select a wait policy', toolPlaceholder: 'Select a built-in tool',
      itemsPathPlaceholder: 'For example: nodes.query.output.records', batchSizePlaceholder: '1-500', concurrencyPlaceholder: '1-32',
      rateLimitPlaceholder: '1-1000', failureThresholdPlaceholder: '1-10000', approvalProviderPlaceholder: 'Approval trigger ID',
      maxRetriesPlaceholder: '0-10', timeoutPlaceholder: '100-3600000 ms', failurePolicyPlaceholder: 'Select failure handling',
      failureTargetPlaceholder: 'Select a failure branch target', workflowInputSchema: 'Input', workflowVariablesSchema: 'Variables',
      workflowOutputSchema: 'Output', finalOutput: 'Final output', resourceBindings: 'Resources',
      workflowSettingsHint: 'Configure workflow-wide data contracts and resource aliases. Click blank canvas space to return here.',
      invalidEndpoint: 'Invalid edge endpoint', selfEdge: 'A node cannot connect to itself', endOutgoing: 'End nodes cannot have outgoing edges',
      startIncoming: 'Start nodes cannot have incoming edges', duplicateEdge: 'This edge already exists',
      cycleEdge: 'This edge creates an unsupported cycle', copiedVariable: 'Copied {value}',
      categories: { control: 'Flow control', data: 'Data processing', ai: 'AI capabilities', integration: 'Integrations' },
      nodes: { start: 'Start', end: 'End', condition: 'Condition', parallel: 'Parallel gateway', delay: 'Delay', wait_event: 'Wait event', batch_loop: 'Batch loop', aggregate: 'Aggregate', transform: 'Transform', builtin: 'Built-in tool', datasource: 'Data source', rag: 'Knowledge retrieval', llm: 'LLM', nl2sql: 'NL2SQL', skill: 'Skill', agent: 'Agent task', api: 'API', subflow: 'Subflow' },
      builtins: { current_datetime: 'Current date and time', date_calculate: 'Date calculation', calculator: 'Calculator', unit_convert: 'Unit conversion' },
      aggregateOptions: { object: 'Merge objects', concat: 'Concatenate arrays', coalesce: 'First non-empty', branch_union: 'Union branches' },
    ...
    help: {
      workflowTitle: 'Workflow Configuration Guide', triggerTitle: 'Trigger Configuration Guide', runtimeTitle: 'Runtime and Failure Guide',
      workflowIntro: 'Choose a starter template, then connect nodes according to data dependencies. Validate schemas, mappings, bindings, and failure policies before publishing.',
      triggerIntro: 'Triggers only start published workflows. Select workflows by name and use Cron presets, standard timezones, and JSON examples to reduce errors.',
      runtimeIntro: 'Runs, attempts, events, dead letters, and statistics form the execution evidence. Safe retries stay pinned to the original version and never overwrite history.',
      stepsTitle: 'Quick start', fieldsTitle: 'Configuration details', examplesTitle: 'Complete example', notesTitle: 'Acceptance and notes',
      workflowSteps: '1. Choose a blank, sequential, approval, or batch template and enter a stable code.\n2. Click blank canvas space to configure workflow input, variables, output, final output, and resource bindings.\n3. Add and connect nodes; select managed resources and configure mappings and output schemas.\n4. Set timeouts, retries, and failure branches, then run validation.\n5. Publish a test version, then use Run published version to verify the path; draft changes require publication before they take effect.',
      triggerSteps: '1. Publish the workflow, then choose Schedule, Webhook, Internal Event, or Approval Callback.\n2. Select the workflow and enter a purpose-oriented name.\n3. Configure frequency, timezone, misfire window, and overlap for schedules; configure schemas and signature windows for other types.\n4. Configure input and variables in the JSON editor, save, then enable.\n5. Store one-time secrets immediately and verify a real callback.',
      runtimeSteps: '1. Confirm final and node states in Workflow Runs.\n2. Check start, wait, external event, and completion order in Timeline.\n3. Inspect every Attempt, worker, and error in Execution Logs.\n4. Retry Failed Tasks only after confirming idempotency; verify event receipt, matching, and triggering.\n5. Monitor backlog, waits, failure rate, and reconciliation.',
      workflowFields: 'Workflow settings use JSON Schema objects for input, variables, and output; final output and resource bindings are arrays. Data paths use workflow.input, workflow.variables, trigger.payload, nodes.<nodeId>.output, or loop.item/index/key. API, Skill, datasource, NL2SQL, and subflow resourceAlias values must match a binding. RAG searches the tenant index with the run identity ACL and has no resource alias. LLM nodes require a structured outputSchema. Batch itemsPath must resolve to an array. Approval waits require a provider ID, correlation path, and PT1M-P30D timeout.',
      triggerFields: 'Cron uses Spring six-field order: second, minute, hour, day, month, weekday; timezone must be an IANA name. The 7-day preset runs every Monday and the 30-day preset runs on day 1 of each month, so both are calendar schedules. Misfire window controls recovery compensation and overlap policy controls skip, queue, parallel, or replacement behavior. Webhook and approval secrets are shown once; schemas, input, and variables must be JSON objects.',
      runtimeFields: 'Runs retain the pinned version, node trace, loop batches, and timeline; logs retain every Attempt. Event records separate received and published events, while Failed Tasks retain category and dead-letter status. A retry creates a new run and does not overwrite history. Retry side-effecting calls only when protected by idempotency.',
      workflowExample: 'Automatic complaint handling\nStart -> NL2SQL(complaint_db) -> RAG -> Transform -> LLM -> Batch API(after_sales_api) -> Wait approval -> Batch API -> End\nResource aliases: complaint_db / after_sales_api; RAG uses tenant index, ACL, and input filters\nBatch itemsPath: nodes.plan.output.tickets\nApproval key: workflow.input.batchId; timeout: PT24H',
      triggerExample: 'Daily 09:00: 0 0 9 * * *\nEvery 7 days (Monday 09:00): 0 0 9 * * MON\nEvery 30 days (day 1 at 09:00): 0 0 9 1 * *\nTimezone: Asia/Shanghai; misfire window: 300 seconds; overlap: Skip',
      runtimeExample: 'Success criteria\n- One runId covers query, generation, batch submission, approval wait, and completion\n- Final status is SUCCESS and every required node completed\n- External records, callback events, loop items, and audit timeline agree\n- Failure, timeout, and retry evidence remains traceable',
      workflowNote: 'Validation must pass before publish. Resource aliases are resolved and pinned on publish; transform and aggregate nodes require mappings and output schemas; failure targets must exist and cannot reference the same node.',
      triggerNote: 'Rotating a secret invalidates the old secret immediately. Months are not exactly 30 days, so the 30-day preset runs on day 1; use a dedicated interval scheduler for strict elapsed-time intervals.',
      runtimeNote: 'Do not delete failures to obtain a green result. Failures, timeouts, manual outcomes, and reconciliation results are acceptance evidence; confirm idempotency before retrying.'
    }
  }
};
