const local: App.I18n.Schema = {
  ...
  rag: {
    ...
    skill: {
      ...
      aiIntro: 'Enter a name, code, and complete workflow description. The system explores tenant-scoped atomic tools and generates a disabled Skill draft.',
      ...
      aiRequiredFields: 'Name, code, and complete description are required',
